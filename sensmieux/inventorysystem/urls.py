...
from . import views
from .views import export_expiry_dates
from .views import export_pricelists
from django.contrib.auth import views as auth_views
from django.views.generic.base import RedirectView

urlpatterns = [
    path('export-expiry-dates/', export_expiry_dates, name='export_expiry_dates'),
    path('export-pricelists/', export_pricelists, name='export_pricelists'),
    ...
    path('inventory/<int:pk>',views.inventory_history,name='inventory-history'),
