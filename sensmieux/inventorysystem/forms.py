...
from .models import Product, Stock, Invoice, Invoice_Item
...
class SaveProduct(forms.ModelForm):
    ...
    class Meta:
        model = Product
        fields = ('code','name','lotnumber','cost','price','expiry','status')
...
class SaveInvoiceItem(forms.ModelForm):
    ...
    lotnumber = forms.CharField(max_length=100)
    expiry = forms.CharField(max_length=100)
    price = forms.CharField(max_length=100)

    class Meta:
        model = Invoice_Item
        fields = ('invoice','product','quantity','lotnumber','expiry','price')
